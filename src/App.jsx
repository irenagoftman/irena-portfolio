  ...
  return (
    <div className="min-h-screen bg-neutral-100 text-neutral-900">
      ...
      <section id="about" className="max-w-6xl mx-auto px-4 py-12">
        ...
        <p className="mt-4 text-neutral-700">My name is Irena Goftman and I'm an Israeli self-taught artist. I was born in Ukraine in 1989 and very proud of being a part of this beautiful country. Our family imigrated to Israel when I was 11 years old, but my heart is still there with my friends and beloved city Kharkiv.
...
My love for abstract art began a long time ago, but I did not try to paint myself, but only admired the works of Picasso, Kandinsky and others. To create on my own is not just an opportunity for me to convey feelings and emotions hidden deep in my soul, but also to add bright colors to the lives of people who will hang my paintings in their homes, look at them and find something personal for themselves.</p>
      </section>
